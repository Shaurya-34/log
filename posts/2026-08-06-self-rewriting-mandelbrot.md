---
title: A renderer that keeps notes on itself
date: 2026-08-06
...
<figure>
  <img src="images/mandelbrot_images/cache.png" alt="A terminal showing mandel.py run twice: the first run prints 'Cache miss' with an elapsed time of 7.64 seconds, the second prints 'Cache hit' with an elapsed time of 0.01 seconds, both followed by the identical SHA-256 cache key.">
...
<figure class="color">
  <img class="color" src="images/mandelbrot_images/Sequence.png" alt="A terminal showing a Python script that iterates z = z² + c for a single point (c=1) and prints each value; the sequence diverges rapidly by z(9)">
