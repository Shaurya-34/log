...
<div class="colormap-carousel">
  <div class="colormap-track">
    <figure class="colormap-slide" id="cm-inferno">
    ...
    <figure class="colormap-slide" id="cm-viridis">
    ...
    <figure class="colormap-slide" id="cm-magma">
    ...
    <figure class="colormap-slide" id="cm-plasma">
    ...
    <figure class="colormap-slide" id="cm-cividis">
    ...
    <figure class="colormap-slide" id="cm-twilight">
    ...
    <figure class="colormap-slide" id="cm-turbo">
    ...
    <figure class="colormap-slide" id="cm-jet">
    ...
    <figure class="colormap-slide" id="cm-rainbow">
    ...
    <figure class="colormap-slide" id="cm-gist-rainbow">
    ...
    <figure class="colormap-slide" id="cm-nipy-spectral">
